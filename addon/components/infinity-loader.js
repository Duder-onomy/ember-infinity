...
const InfinityLoaderComponent = Component.extend(InViewportMixin, {
  ...
  classNameBindings: ['reachedInfinity', 'viewportEntered:in-viewport'],
  /**
   * @public
  ...
  isVisible: true,
  /**
   * proxy of infinityModel.reachedInfinity
   *
  ...
  infinityModelContent: computed('infinityModel', function() {
  ...
  didInsertElement() {
    ...
    get(this, 'infinityModelContent')
      .then((infinityModel) => {
        ...
        let scrollableArea = get(this, 'scrollable');
        run(this, () => set(infinityModel, '_scrollable', scrollableArea));
      });
  },
